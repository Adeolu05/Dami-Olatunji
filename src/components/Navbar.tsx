...
import { Menu, X, Instagram, Youtube, Facebook, ChevronRight } from 'lucide-react';
...
const Navbar: React.FC = () => {
  ...
  // All pages now have a hero section with dark background, so we want white text initially on all pages.
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            ...
            >
              ...
              >
                {[
                  { icon: Instagram, href: "https://www.instagram.com/damiolatunji_" },
                  { icon: Youtube, href: "https://youtube.com/@damiolatunji" },
                  { icon: Facebook, href: "https://www.facebook.com/damilola.oladele.9026" }
                ].map((social, idx) => (
                  <a
                    key={idx}
                    href={social.href}
